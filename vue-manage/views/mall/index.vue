<template>
  <div class="manage">
    ...
    <div class="manage-header">
      <el-button type="primary" @click="addCommodity">+ 新增</el-button>
      <common-mall-form
        :formLabel="formLabel"
        :form="searchForm"
        :inline="true"
...
<script>
import CommonMallForm from "../../src/components/CommonMallForm.vue";
import CommonMallTable from "../../src/components/CommonMallTable.vue";
